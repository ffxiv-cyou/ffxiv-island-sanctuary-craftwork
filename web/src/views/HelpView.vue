<template>
  <div class="about">
    ...
    <p>排班表用于计算并规划本周的排班。</p>
    <ul>
      <li>使用全表计算需求变动：在推荐时使用全部已选择方案计算叠箱，而不是仅使用当天之前的方案计算叠箱。
        此功能在倒序选择推荐方案的情况下可能得到更优的方案。启用后，推荐队列的预计收益会与排班表计算不一致。</li>
      <li>总收益：本周预计总收益</li>
    ...
    <p>若在使用中遇到了问题，请在<a href="https://nga.178.com/read.php?tid=34882091" target="_blank">NGA帖子</a>下留言。</p>
  </div>
</template>
